...
const ViewsPage = () => {
  return (
    ...
    <>
      <p>
        Loading existing views coming soon. Click the button below to create one:
      </p>
      <Link
        to={"/views/new/color"}
        className={"bg-sky-400 rounded-lg hover:bg-sky-600 active:bg-sky-800 px-4 py-2 mt-8 cursor-pointer inline-block"}
      >
        + New
      </Link>
    </>
